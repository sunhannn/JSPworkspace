      ...
      bgcolor="<%=bodyback_c%>" align="center">
         ...
         <tr height="30">
            <td align="right" bgcolor="<%=value_c%>" colspan="4">
               ...
               onclick="document.location.href='updateForm.jsp?num=<%=article.getNumber()%>&pageNum=<%=pageNum %>'">
               &nbsp;&nbsp;&nbsp;&nbsp;

               <input type="button" value="글삭제"
               onclick="document.location.href='deleteForm.jsp?num=<%=article.getNumber()%>&pageNum=<%=pageNum %>'">
               &nbsp;&nbsp;&nbsp;&nbsp;
