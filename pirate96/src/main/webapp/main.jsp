		...
		<form method="post">
			<jsp:include page="../header.jsp" flush="true" />
					...
					<div class="main">	
                        ...
                        <h3>*오늘의 한마디*</h3>
                        <div class="row">
                          <div class="col-sm-6" style="width:600px; height: 400px; padding-right:0 auto;" >
                           <img alt="대나무숲" src="../img/대나무속 햇볕.jpg"
                           style="width:600px; height:400px;">
                           </div>            
                        <div class="col-sm-6" style="height: 400px; width:600px; padding-left:0 auto;">
                        <hr style="border-top: 2px ridge skyblue;">
                        <h4 style="text-align: center;">*오늘의 한마디*</h4>
                        <p>1.팀장의 말을 잘 듣자</p>
                        <p>2.컨디션 잘 챙기자</p>
                       ...
                       <!-- 영역구분선 -->  
                        ...
                        <div class="col-sm-6" style="width:600px; height:400px; padding-left:0 auto;">
                        <hr style="border-top: 2px ridge skyblue;">
                        ...
                        <div class="row">
                          <div class="col-sm-6" style="width:600px; height:400px; padding-right:0 auto;">
                            ...
                            width="600px" height="400px" allowfullscreen="false" style="border:0;"
                            loading="lazy" referrerpolicy="no-referrer-when-downgrade">   
                           </iframe>
                           </div>
                           <br>            
                        <div class="col-sm-6" style="width:600px; height:400px; padding-left: auto;">
                        <hr style="border-top: 2px ridge skyblue;">
                        <h4 style="text-align:center">*주변 교통정보*</h4>
                        <p>1.가까운 전철역: 안양역</p>
                        <p>2.가까운 버스정류장: 안양1번가 또는 중앙시장(맞은편) 하차</p>
                        <p>3.주변 주차장이용</p>
                        <p>&nbsp;&nbsp;&nbsp;자세한 정보는 공개소개및 위치 페이지에서 확인해주세요~</p>
                        <br><br><br><br><br><br>
                        <hr style="border-top: 2px ridge skyblue;">
                        </div>
                        </div><!-- row의 div -->
