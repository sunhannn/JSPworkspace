				...
				<div class="row">
					...
					<div class="col-sm-6"
						...
						<iframe
							...
							width="600px" height="320px" allowfullscreen="false"
					...
					<div class="col-sm-6"
						...
						<h4 style="text-align: center;">*하이미디어 스터디룸카페는 !!!*</h4>
						<br>
			...
			<div class="container-fluid">
				...
				<div class="row">
					...
					<div class="col-sm-6"
						...
						<p>1.근접한 전철역: 안양역</p>
						<p>
							2.근접한 버스정류장 <br>안양번가정류장 or 안양중앙시장(건너편)에서 하차 <br>마을버스:
							2,3-1,9,5-1번 버스등 <br>일반버스:
							5530,5626,5623,88,8,64,65,1-2,1,3번 버스등 <br>광역버스:
							M5556,M5333,333,3330번 버스등
						</p>
						<p>
