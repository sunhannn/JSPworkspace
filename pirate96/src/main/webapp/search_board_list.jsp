...
<div class="list_a"><a href="boardWriteForm.go" style="color:black;">게시판글쓰기</a></div>
	...
	<section id="pageList">
			...
			%>
			<button type="button" class="paging_btn" onClick="location.href='boardSearchList.go?page=<%=nowPage - 1%>&search=<%=list_search%>&search_value=<%=list_search_value%>'">이전</button>&nbsp;
			<%
			}
			%>
			...
			%>
			<button class="paging_btn" onClick="location.href='boardSearchList.go?page=<%=a%>&search=<%=list_search%>&search_value=<%=list_search_value%>'"><%=a%>
			</button>
			&nbsp;
			<%
			}
         ...
         다음
			...
			%>
			<button type="button" class="paging_btn" onClick="location.href='boardSearchList.go?page=<%=nowPage + 1%>&search=<%=list_search%>&search_value=<%=list_search_value%>'">다음
         </button>
			<%
			}
			%>
