...
<body>
	...
	<div class="content_all">
		<section>
			...
			<div class="text_zone">
				<form action="reserveModifyPro.go" method="post"
					...
					<table class="write_table">
						<tr>
							...
							<td class="td_content"><input class="modi_input" type="text"
								name="R_ID" id="R_ID" value="<%=article.getR_ID()%>" DISABLED /></td>
						</tr>
						<tr>
							<td class="td_sub"><label for="R_NAME">이름</label></td>
							<td class="td_content"><input class="modi_input"
								name="R_NAME" type="text" id="R_NAME"
								value="<%=article.getR_NAME()%>" required="required" /></td>
						</tr>
						<tr>
							<%
							...
							<td class="td_content"><select class="modify_select"
								name="R_ROOM" id="R_ROOM">
						...
						<tr>
							...
							<td class="td_content"><input class="modi_input" id="R_PRI"
								name="R_PRI" value=<%=article.getR_PRI()%> required="required" /></td>
						</tr>
						<tr>
							<td class="td_sub"><label for="R_PH">핸드폰 번호</label></td>
							<td class="td_content"><input class="modi_input" id="R_PH"
								name="R_PH" value=<%=article.getR_PH()%> required="required" />
							</td>
						</tr>
