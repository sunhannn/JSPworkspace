	...
	<div class="content_all">
		...
		<div class="text_zone">
			...
			<div class="container">
				...
				<form class="needs-validation" action="memberUpdateAction.go"
					...
					<div class="form-group">
						<button type="submit" class="from-control">수정하기</button>
					</div>
				</form>
			</div>
...
// 	  e.preventDefault(); //위에서 막아준 거 한번 더 막아준거임 혹시나해서
	  ...
	  var emailRegex = /^[-0-9A-Z_a-z]+@[A-Za-z]+.[A-Za-z]+$/, //안됨
// 	  정규식패턴 /^시작해서 $/로 끝남
	  idRegex = /^[0-9A-Z_a-z]+$/, //안됨
	  phoneRegex = /^010\d{4}\d{4}$/, //안됨
