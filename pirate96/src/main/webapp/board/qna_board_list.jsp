...
<body>
	...
	<div class="wrapper">
						...
						<tbody>
							...
							<tr>
								...
								<td><a style="color: gray;"
									href="boardDetail.go?board_num=<%=articleList.get(i).getBOARD_NUM()%>&page=<%=nowPage%>">
		...
		<footer class="footer">
			<br>
			<p style="background-color: #f5f6f7; margin: 0;">현재 사이트는 교육용으로
				제작된 웹사이트로 실제로는 사용불가능합니다.</p>
			<p style="background-color: #f5f6f7; margin: 0;">카피라이터: 1조 평균나이
				96년생</p>
			<p style="background-color: #f5f6f7; margin: 0;">팀장: 한상현, 부팀장:
				박수빈, 팀원: 김선찬, 송채은, 윤지원</p>
		</footer>
		<!--footer영역끝-->
	</div>
</body>
