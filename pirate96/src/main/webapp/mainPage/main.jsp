    ...
    <form method="post">
          <div id="mainpage">
             <header>
               <div id="logo"> <!--이미지로고 추가할시 사용--> 
                ...
                <nav> <!--메뉴바 목록들-->
                 <ul class="menubar">
                   <li><a href="#" onclick="location.href='../mainPage/main.jsp'">HOME</a></li>
                   <li><a href="#" onclick="location.href='../boardGo.go'">공지</a></li>
                   <li><a href="#" onclick="location.href='QnA.html'">QnA</a></li>
                   <li><a href="#" onclick="location.href='location.html'">공간소개 및 오시는 길</a></li>
                   <li><a href="#" onclick="location.href='../firstRev.jsp'">스터디룸 예약</a></li>
                   <li><a href="#" onclick="location.href='../admin.jsp'">관리자 페이지 가기</a></li>
                 </ul>
                 <div>
                  <li class="login"style="margin-right: 30px;"><a href="../loginForm.jsp">LOGIN</a></li>
                 </div>
                </nav>      
             </header>
           </div>
      ...
      <div class="container">  
             ...
             <div class="main"><!--화면양쪽에 여백부여-->
                ...
                <hr style="border-width:thin; border-color: rgb(110, 178, 238);"> <br><br> <!--헤더밑 경계선-->
                <div class="menu"><!--공지작성영역-->
                  <div style="width: 350px; height: 300px; float: left; margin-right: 30px;">
                    <h3>*공지사항*</h3>        
                    <img src="img/대나무속 햇볕.jpg" alt="대나무숲" style ="width: 340px; height: 280px;">
                 </div>
                 <div style="width: auto; height: auto;"></div>
                 <br><br>
                 <div style="width: 400px; height: 250px; float: left; border-top: 2px ridge navy; 
                 border-bottom: 2px ridge navy;">
                    <h4 style="text-align: center;"><a>*공지사항*</a></h4>
                  <p>심심</p>
                    
                 </div>
                </div><div style="clear: both;"></div><!--영역아래의 div가 따라올라가는 것을 방지-->

                <hr style="border:2px solid skyblue"><br><br>
                <!--예약방법 작성영역-->
             <div class="menu">
               <div style="width: 400px; height: 300px; float: left; margin: auto;">
                 <h3>*스터디룸 예약*</h3>
               ...
               <br><br>
                <div style="width: 400px; height: 250px; float: left; border-top: 2px ridge navy; 
                border-bottom: 2px ridge navy;">
                  <h4 style="text-align: center;"><a>*스터디룸예약*</a></h4>
                  <p>방법1</p>
                  <p>방법2</p>
                  <p>방법3</p>
               </div>
             ...
             <hr style="border:2px solid skyblue"><br><br>
             <div class="menu">
                <div style="width: 350px; height: 300px; float: left; margin-right: 30px;"><br> <!--구글지도- 위치변경시 src에 지도소스넣으면됨 -->
                  <h3>*공간소개 및 오시는 길*</h3>
                ...
                <div style="width: auto; height: auto;"></div><br><br><br>
                <div style="width: 400px; height: 250px; float: left; border-top: 2px ridge navy; 
                      border-bottom: 2px ridge navy;">
                   <h4 style="text-align: center;"><a>*주변 교통정보*</a></h4>
