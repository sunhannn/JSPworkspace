...
<body>
    ...
    <div class="container-fluid" style="width: 500px; height: 500px;">
        <div>
            ...
            <p style="font-size: 20px; font-weight: bold; text-align: center; font-family:  Comic
                Sans, Apple Chancery , cursive;">상현 스터디 룸 카페</p>
        </div>
    ...
    <div class="container-fluid" style="text-align: center; width: 1500px;">
        <form action="revJjin.jsp">
            <div style="width: 700px; height: 600px; float: left;">
                ...
                <br> <img class="roomImg" src="./img/room1.jpg" style="width: 400px; height: 400px;">
    ...
    <div class="container-fluid" style="text-align: center; width: 1500px;">
        <form action="revJjin.jsp">
            <div style="width: 700px; height: 600px; float: left;">
                ...
                <br> <img class="roomImg" src="./img/room2.jpg" style="width: 400px; height: 400px;">
    ...
    <div class="container-fluid" style="text-align: center; width: 1500px;">
        <form action="revJjin.jsp">
            <div style="width: 700px; height: 600px; float: left;">
                ...
                <br> <img class="roomImg" src="./img/room3.jpg" style="width: 400px; height: 400px;">
