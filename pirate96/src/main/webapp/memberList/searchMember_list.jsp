...
<%@page import="action.KanMemberSearchAction"%>
<%@page import="vo.MemberVO"%>
<%@ page language="java" contentType="text/html; charset=UTF-8"%>
<%@ page import="java.util.*"%>
<%@ page import="java.text.SimpleDateFormat"%>
<%@page import="controller.StudyServlet"%>
				...
				<div class="admin_area">
					...
					<section id="pageList">
						...
						<button type="button" class="paging_btn"
							onClick="location.href='memberSearch.go?search=<%=list_search%>&search_value<%=list_search_value%>'">이전</button>
						&nbsp;
						<%
						}
						%>
						...
						<button class="paging_btn"
							onClick="location.href='memberSearch.go?search=<%=list_search%>&search_value<%=list_search_value%>?page=<%=a%>'"><%=a%>
						</button>
						<%
						}
						%>
						...
						%>
						<button type="button" class="paging_btn"
							onClick="location.href='memberSearch.go?search=<%=list_search%>&search_value<%=list_search_value%>?page=<%=nowPage + 1%>'">다음
						</button>
						<%
						}
						%>
					...
					<section id="emptyArea">
						조회 가능한 회원이 없습니다.<br>다시 확인 후 검색해주세요.
					</section>
					<%
					}
					%>
